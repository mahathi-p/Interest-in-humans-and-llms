...
# Some of the features and average human INT ratings are in this file:
all_feat<-read.csv("https://anonymous.4open.science/r/Interest-in-humans-and-llms-7020/data/all_llms_human.csv")
# this has 6656 rows
# conversation_id
...
# https://anonymous.4open.science/r/Interest-in-humans-and-llms-7020/data/all_llms_human.csv
...
setwd("/Users/XXX/Library/CloudStorage/OneDrive-UniversityofYYY/rdf/data/all_label_dir")
...
setwd("~/Library/CloudStorage/OneDrive-UniversityofYYY/rdf/data")
...
gispy<-read.csv("https://anonymous.4open.science/r/Interest-in-humans-and-llms-7020/data/rerun_gispy_output.csv")
...
similarity<-read.csv("https://anonymous.4open.science/r/Interest-in-humans-and-llms-7020/data/complete_similarity_metrics.csv", header=T)
similarity<-similarity[,c(2:3,7,10)]
names(similarity)[1]<-"doccano_id"
all<-merge(all,similarity,by=c("conversation_id","doccano_id"))
complexity<-read.csv("https://anonymous.4open.science/r/Interest-in-humans-and-llms-7020/data/complete_complexity_metrics.csv",header=T)
...
uptakes<-read.csv("https://anonymous.4open.science/r/Interest-in-humans-and-llms-7020/data/all_uptakes_final.csv",header=T)
...
uptakes_eck<-read.csv("https://anonymous.4open.science/r/Interest-in-humans-and-llms-7020/data/convokit_uptake.csv",header=T)
...
prof<-read.csv("https://anonymous.4open.science/r/Interest-in-humans-and-llms-7020/data/proficiency.csv")
